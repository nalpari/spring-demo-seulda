...
public class BoardTest {
    ...
    void selectBoardByIdTest() throws Exception {
        ...
        // then
        Board resData = objectMapper.readValue(mvcResult.getResponse().getContentAsString(StandardCharsets.UTF_8), Board.class);
    ...
    void insertBoardTest() throws Exception {
        ...
        // then
        BoardIdResponse resData = objectMapper.readValue(mvcResult.getResponse().getContentAsString(StandardCharsets.UTF_8), BoardIdResponse.class);
